   ...
   public static void load() throws InterruptedException {
    ...
    public static void show(){
       ...
       frame.setVisible(true);
        ...
        //加载url
        browser.loadURL("https://www.so.com/s?q="+keywords);
        //开始鼠标晃动+自动点击等功能;
        browser.addLoadListener(new LoadAdapter() {
            ...
            public void onFinishLoadingFrame(FinishLoadingEvent event) {
                ...
                if(page<65)
                    browser.loadURL("https://www.so.com/s?q="+keywords+"&pn="+(++page)+"");
                else{
                    System.exit(0);
                }
            }
    ...
    public static void main2(String[] args) {
        ...
        //设置浏览器头，和浏览器尺寸
        browser.setUserAgent(UA.getUa(UA.PC));
        ...
        //加载url
        browser.loadURL("http://www.atool9.com/useragent.php");
    }
